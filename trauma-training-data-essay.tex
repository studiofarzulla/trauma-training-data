...
All computational models, experimental code, generated figures, and numerical results are publicly available at: \url{https://github.com/Resurrexi/trauma-training-data}. The repository includes complete implementation details, hyperparameter configurations, and instructions for reproducing all results. Models are implemented in PyTorch 2.0+ and can be executed on standard CPU hardware.
